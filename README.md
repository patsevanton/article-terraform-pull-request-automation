...
## Глава I. Введение
### A. Зачем нужен инструмент для управления инфраструктурными изменениями?
...
Вот несколько причин, почему инструмент для управления инфраструктурными изменениями, такой как Atlantis, становится необходимым:
 ...
 * Совместная работа: Команды разработчиков и DevOps-инженеров часто работают над инфраструктурными изменениями параллельно. Инструмент управления изменениями должен обеспечивать возможность совместной работы, конфликтов разрешения и обмена обновлениями между участниками команды.
...
Atlantis значительно упрощает и автоматизирует процесс управления инфраструктурными изменениями. Вот какие преимущества привносит автоматизация рабочего процесса с помощью Atlantis:
